    ...
    public partial class DatosPrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_PeliculaSalaCine_SalaCines_SalasDeCineID",
            ...
            migrationBuilder.RenameIndex(
                name: "IX_PeliculaSalaCine_SalasDeCineID",
                table: "PeliculaSalaCine",
                newName: "IX_PeliculaSalaCine_SalasDeCineId");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 10, 22, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 10, 27, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 10, 22, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
